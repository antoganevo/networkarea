                ...
                <main>
                    ...
                    <div class="card-header mt-2">
                            ...
                            <thead>
                                ...
                                <tbody>
                                    <?php
                                        $ambilsemuadatamodul = mysqli_query($conn, "SELECT * FROM modulk WHERE iduniq = '$iduniq'");
                                        $i = 1;
                            ...
                            <br>
                            <a target="blank" href="cetakmodul.php"><button  class="btn btn-success">Cetak PDF</button></a>
                    </div>
                    <div class="card-header mt-2">
                    </div>
                </main>
