                    ...
                    <div class="card-header mt-2">
                            ...
                            <div class="table-responsive">
                                ...
                                <thead>
                                    ...
                                    <tbody>
                                        <?php
                                            $ambilsemuadatapatchcore = mysqli_query($conn, "SELECT * FROM patchcorek WHERE iduniq = '$iduniq'");
                                            $i = 1;
                                ...
                                <br>
                                <a target="blank" href="cetakpc.php"><button  class="btn btn-success">Cetak PDF</button></a>
                            </div>
                        </div>
                        <div class="card-header mt-2">
                        </div>
